        ...
        public IEDCFileParser GetParserForFile(string filename, bool isPrimaryFile)
        {
            ...
            switch (fileType)
            {
                case EDCFileType.EDC15P:
                    parser = new ECU.EDC15.EDC15PFileParser();
                    break;
                case EDCFileType.EDC15P6:
                    parser = new ECU.EDC15.EDC15P6FileParser();
                    break;
                case EDCFileType.EDC15V:
                    parser = new ECU.EDC15.EDC15VFileParser();
                    break;
                case EDCFileType.EDC15C:
                    parser = new ECU.EDC15.EDC15CFileParser();
                    break;
                case EDCFileType.EDC15M:
                    parser = new ECU.EDC15.EDC15MFileParser();
                    break;
